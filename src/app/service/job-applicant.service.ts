...
import { JobApplicant, PageJobApplicant } from '../model/jobApplicant.model';
...
export class JobApplicantService {
  ...
  public save(jobApplicant: JobApplicant) {
    ...
    formData.append('createdDate', jobApplicant.createdDate);
